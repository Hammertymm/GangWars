#!/usr/bin/env python3
"""Measure Crime Ledger reference PNGs and print blueprint rects (473×1024 canvas)."""
...
# Hard-coded rects from visual measurement of reference art (px on 473×1024).
BLUEPRINT = {
    ...
    "home": {
        ...
        "inpaint": [
            {"x": 130, "y": 486, "w": 213, "h": 18, "label": "total"},
            {"x": 268, "y": 542, "w": 92, "h": 16, "label": "general"},
            {"x": 238, "y": 594, "w": 92, "h": 16, "label": "rare"},
            {"x": 318, "y": 646, "w": 92, "h": 16, "label": "superRare"},
            {"x": 268, "y": 698, "w": 72, "h": 16, "label": "godlike"},
            {"x": 368, "y": 750, "w": 52, "h": 16, "label": "goldenGodlike"},
        ],
    },
    "general": {
