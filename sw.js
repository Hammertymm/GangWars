...
const ASSETS = [
  ...
  './cards/nobody.png',
  './cards/big-daddy-j-portrait.png',
...
const SHELL_PATTERN = /\/(gangwars\.html|gangwars\.css|engine\.js|ledger\.js|ledger-blueprint\.js|ledger-ui\.js|audio\.js|sw\.js)$/;
